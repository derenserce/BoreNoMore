...
<template>
  <div class="flex flex-col items-center justify-center text-start xl:gap-24">
    ...
    <div class="max-w-md md:text-lg">
      <p>
        Welcome to BoreNoMore, where boredom meets its match. We understand that life can sometimes
    ...
    <div class="mt-4 flex justify-center gap-4">
      <button @click="fetchFree?.()" class="buttonActivity">🔎 Free activity</button>
      <button @click="fetchPaid?.()" class="buttonActivity">🔎 Paid activity</button>
    </div>
  </div>
</template>
