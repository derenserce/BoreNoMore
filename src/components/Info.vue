...
<template>
  <div class="mx-auto flex max-w-lg flex-col gap-4 overflow-y-scroll xl:mx-0 xl:max-w-md xl:py-24">
    <ul>
      <ActivityCard :activity="activity" />
    </ul>
    <div class="overflow-y-scroll rounded-xl bg-gray-900/80 p-4" v-if="activityStore.favorites.length > 0">
