...
<template>
  <div
    class="mx-auto flex h-screen max-h-screen overflow-y-clip flex-col gap-10 bg-neutral-800 p-5 text-center text-white md:px-28 lg:px-40 xl:flex-row xl:justify-around xl:bg-cover xl:px-32 2xl:bg-img 2xl:px-32">
    <General
